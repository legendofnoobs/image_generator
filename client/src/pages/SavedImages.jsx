...
const SavedImages = () => {
    ...
    return (
        <div className="relative z-50  m-auto">
                ...
                <div className="flex flex-col gap-4 m-auto">
                    {savedImages.length > 0 ? (
                        savedImages.map((image) => (
                            <div
                                key={image._id}
                                className="flex flex-col sm:flex-row items-center border border-zinc-400 gap-x-4 p-3 rounded-lg bg-zinc-800 hover:scale-105 duration-300 transition-all cursor-default max-w-4xl m-auto"
                            >
                                <img src={image.image} alt="Saved" className="sm:w-56 w-full h-auto rounded-lg" />
                                <div className="flex flex-col gap-2 text-white mt-2 sm:mt-0">
